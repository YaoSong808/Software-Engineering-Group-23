...
/**
 * This is the controller class for account.fxml ("My Account" view）
 */
...
public class AccountController {
    ...
    /**
     * Show the user's transaction data and default UI in "My Account" page based on user role
     */
    @FXML
    ...
    /**
     * Get the user's transaction data from csv file according to time range and transaction category.
     *
    ...
    /**
     * Show one transaction record(event) into "My Account" transaction list.
