...
/**
 * This class is to define the constants of csv and picture files name with path
 */
...
public class FileName {
    ...
    public static final String defaultGiftFile = userDir + "/src/com/kidsbank/staticfile/gift_page.png";
