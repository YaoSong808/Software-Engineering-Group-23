...
/**
 * This is the controller class for task_edit.fxml ("Earn Money" -> "Open Tasks" -> "Edit a Task"  view）
 */
...
public class TaskEditController {
    ...
    /**
     * Pass specific task row data to current page
     */
    ...
    /**
     * Show the task info and default UI in "Earn Money"->"Edit a Task" page
     */
    @FXML
    ...
    /**
     * Update the tasks with input new value in "Edit a Task" pop up window
     */
    @FXML
    ...
    /**
     * Cancel the task info update in "Edit a Task" page
     */
    @FXML
