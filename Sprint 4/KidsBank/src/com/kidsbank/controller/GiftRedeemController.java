...
/**
 * This is the controller class for gift_redeem.fxml ("Redeem Gifts" -> gifts list view）
 */
...
/**
* Show gift list in "Redeem Gift" page based on user role
*/
@FXML
    ...
    /**
     * Show the balance for redeem gifts and show all of available gifts list in "Redeem Gifts" page for parent account
     */
    ...
    /**
     * Show the balance for redeem gifts and show all of available gifts list in "Redeem Gifts" page for child account
     */
    ...
    /**
     * Parent account add a gift in the "Redeem Gifts" page
     */
    ...
    /**
     * Show a gifts in "Redeem Gifts". UI position is based on x/y axis.
