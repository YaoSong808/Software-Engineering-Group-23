...
public class GetTime {
    ...
    /**
     * Get the time for current + specific years.
     * @param year specific year number
     */
    ...
    /**
     * Compare specific time with current system time
    ...
    /**
     * Check if specific time is in latest N months.
     * @param specificTime specific time
     * @param months latest N months
     */
    ...
    /**
     * Convert the time format to new format
     * @param oldFormatDate the time with old format
     */
