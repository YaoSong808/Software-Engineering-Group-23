...
/**
 * This is the controller class for gift_purchased.fxml ("Redeem Gifts" -> "History" view）
 */
...
public class GiftPurchasedController {
    ...
    /**
     * Show the redeemed gifts list and default UI in "Redeem Gift" -> "History" page based on user role
     */
    @FXML
