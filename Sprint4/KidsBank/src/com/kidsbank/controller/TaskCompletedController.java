...
/**
 * This is the controller class for task_completed.fxml ("Earn Money" -> "Completed Tasks" view）
 */
...
public class TaskCompletedController {
    ...
    /**
     * Show completed tasks data and default UI in "Earn Money"-> "Completed Task" page based on user role
     */
    @FXML
