...
/**
 * This is the controller class for setting.fxml ("Settings" view）
 */
...
public class SettingController {
    ...
    /**
     * Show the user's settings and default UI in "Settings" page based on user role
     */
    @FXML
    ...
    /**
     * Set up dark mode in "Settings" page
     */
    @FXML
    ...
    /**
     * Link selected user to current parent account in "Settings" page
     */
    @FXML
    ...
    /**
     * UI effect for the mouse action
     */
    @FXML
    ...
    /**
     * Check specific linked user is default linking account or not
     * @param accountName linked user name
     * @param label UI text label which showed the linked username
     */
