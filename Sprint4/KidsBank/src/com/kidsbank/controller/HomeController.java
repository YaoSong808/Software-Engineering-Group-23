...
/**
 * This is the controller class for home.fxml ("Home" view）
 */
...
public class HomeController {
    ...
    /**
     * Show the user's dashboard and default UI in "Home" page based on user role
     */
    @FXML
    private void initialize(){
        ...
        goalComment.setText("RMB " + String.format("%.2f", totalBalance) + " out of " + Double.toString(goalValue));
    ...
    /**
     * UI action for switching to "Set a saving goal" popup window
     */
    @FXML
    ...
    /**
     * UI action to switching to "My Account" page
     */
    ...
    /**
     * UI action to switching to "Earn Money" page
     */
    @FXML
    ...
    /**
     * UI action to switching to "Redeem Gifts" page
     */
    @FXML
    ...
    /**
     * UI action to switching to "Fixed Deposit" page
     */
    @FXML
